...
public void Connect(){
  ...
  mongo= new  MongoClient("localhost",27017); 
    db=mongo.getDatabase("Final");//database
     collection=db.getCollection("MothersVaccination"); //table
    ...
    private void jButton4ActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_jButton4ActionPerformed
        // TODO add your handling code here:
       VaccineMother vm=new VaccineMother();
        vm.setVisible(true);
        Document doc=new Document("Name",jTextField1.getText());
        doc.append("Age",jTextField2.getText());
         doc.append("Address",jTextField3.getText());

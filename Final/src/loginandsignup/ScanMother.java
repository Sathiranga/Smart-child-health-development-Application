 ...
 */
public class ScanMother extends javax.swing.JFrame {

    /**
     * Creates new form ScanMother
     */
    public ScanMother() {
        initComponents();
         Connect();
 ...
 MongoClient mongo;
  ...
  mongo= new  MongoClient("localhost",27017); 
    ...
    private void initComponents() {
        ...
        jLabel2.setText("Scan Mother Card");
    ...
    public static void main(String args[]) {
        ...
        try {
            ...
            java.util.logging.Logger.getLogger(ScanMother.class.getName()).log(java.util.logging.Level.SEVERE, null, ex);
        ...
        java.awt.EventQueue.invokeLater(new Runnable() {
            public void run() {
                new ScanMother().setVisible(true);
            }
        });
    }

  ...
  mongo= new  MongoClient("localhost",27017); 
    ...
    private void initComponents() {
        ...
        jTable1.setModel(new javax.swing.table.DefaultTableModel(
            ...
            new String [] {
                "Date", "Time", "Id-to", "Type", "Vaccine Name"
            }
        ));
    ...
    private void jButton3ActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_jButton3ActionPerformed
        // TODO add your handling code here:
         ...
         Document doc=new Document("Date",jTextField1.getText());
         doc.append("Time",jTextField2.getText());
          doc.append("Id",jTextField3.getText());
           doc.append("To",jTextField4.getText());
            doc.append("Vaccine Name", jComboBox1.getSelectedItem().toString());
        collection.insertOne(doc);
           DefaultTableModel model = (DefaultTableModel) jTable1.getModel();
        model.addRow(new Object[]{jTextField1.getText(), jTextField2.getText(), jTextField3.getText(), jTextField4.getText(), jComboBox1.getSelectedItem().toString(),selectedType});
